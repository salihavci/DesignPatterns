...
namespace WebApp.Decorator.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            /*
             İf memory'de var mı?
             varsa memory'den dön,
             yoksa veritabanından dön,
             memory'e kaydet,
             datayı dön
             */

            return View(await this.productRepository.GetAll(userId));
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var product = await this.productRepository.GetById(id.Value);
            if (product == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stock")] Product product)
        {
            ...
            {
                product.UserId = User.Claims.First(m => m.Type == ClaimTypes.NameIdentifier).Value;
